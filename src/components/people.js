...
function People() {
  ...
  const handlePostPerson = () => postPerson({ variables: { input: inputs } });
  ...
  const handleEditPerson = () => editPerson({ variables: { id: contentId, input: inputs } });
          ...
          contentId === 0
            ? (
              <div className="buttons">
                <button onClick={() => handlePostPerson()}>Submit</button>
              </div>
            )
            : (
              <div className="buttons">
                <button onClick={() => handleEditPerson()}>Modify</button>
