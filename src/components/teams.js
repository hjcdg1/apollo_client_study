...
function Teams() {
  ...
  const handlePostTeam = () => postTeam({ variables: { input: inputs } });
  ...
  const handleEditTeam = () => editTeam({ variables: { id: contentId, input: inputs } });
          ...
          contentId === 0
            ? (
              <div className="buttons">
                <button onClick={handlePostTeam}>Submit</button>
              </div>
            )
            : (
              <div className="buttons">
                <button onClick={handleEditTeam}>Modify</button>
